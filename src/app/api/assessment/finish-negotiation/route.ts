...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const fullAnalysisPrompt = NEGOTIATION_ANALYSIS_PROMPT.replace('{chat_history_json}', historyJson);
    ...
    console.error('Error finishing Negotiation assessment:', error);
